...
def fitness(hyperparameters):
    ...
    if verbose > 1:
        print('[BAYESIAN SEARCH] [{}/{}] ALPHA: {}'.format(fitness_step, numbayesiansearch, ALPHA))
        print('[BAYESIAN SEARCH] [{}/{}] L1_RATIO: {:.3e}'.format(fitness_step, numbayesiansearch, L1_RATIO))
        print('[BAYESIAN SEARCH] [{}/{}] ETA0: {:.3e}'.format(fitness_step, numbayesiansearch, ETA0))
