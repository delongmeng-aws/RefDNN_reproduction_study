...
def fitness(hyperparameters):
    ...
    if verbose > 1:
        print('[BAYESIAN SEARCH] [{}/{}] N_ESTIMTORS: {:d}'.format(fitness_step, numbayesiansearch, N_ESTIMTORS))
        print('[BAYESIAN SEARCH] [{}/{}] MAX_DEPTH: {:d}'.format(fitness_step, numbayesiansearch, MAX_DEPTH))
